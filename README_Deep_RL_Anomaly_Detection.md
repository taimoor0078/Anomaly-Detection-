...
1. Preprocess and analyse CERT user activity data.
2. Formulate insider threat detection as an RL problem.
3. Define the RL environment, state space, action space, and reward mechanism.
4. Implement DQN, Double DQN, and Dueling DQN.
5. Train agents to distinguish normal and suspicious user behavior.
6. Compare the models using detection accuracy, cumulative rewards, training loss, and convergence behaviour.
7. Analyse the strengths and limitations of different DQN architectures.
8. Identify future improvements for adaptive cybersecurity systems.
...
| `hour_window` | Aggregated time interval representing user activity |
| `login_events` | Number of authentication activities |
| `device_events` | Device usage frequency |
| `file_events` | Number of file access operations |
| `email_events` | Email communication activity count |
| `total_email_size` | Total size of emails exchanged |
| `total_attachments` | Number of email attachments |
| `https_events` | Web browsing activity count |
| `O` | Openness personality score |
| `C` | Conscientiousness personality score |
| `E` | Extraversion personality score |
| `A` | Agreeableness personality score |
| `N` | Neuroticism personality score |
...
1. Combining multiple user activity sources.
2. Removing missing or inconsistent values.
3. Aggregating behavioural activities.
4. Encoding features.
5. Normalising features.
6. Preparing numerical state representations for RL training.
...
| Environment | CERT user behaviour data |
| State | Behavioural features |
| Action | Normal or anomalous classification |
| Reward | Positive/negative feedback based on detection correctness |
| Policy | Strategy learned to maximise future rewards |
...
| Action | Meaning |
|---:|---|
| `0` | Normal user behaviour |
| `1` | Anomalous / suspicious behaviour |
...
| Actual Behaviour | Agent Decision | Result | Reward |
|---|---|---|---:|
| Normal | Normal | Correct | +1 |
| Anomaly | Anomaly | Correct | +1 |
| Normal | Anomaly | False Positive | -1 |
| Anomaly | Normal | False Negative | -1 |
...
5. Updates its Q-value estimates.
...
| Model | Main Purpose |
|---|---|
| DQN | Baseline anomaly detection |
| Double DQN | Reduce Q-value overestimation |
| Dueling DQN | Separate state value and action advantage learning |
...
|---|---|
| Learning Rate | Controls neural-network weight updates |
| Discount Factor (γ) | Determines the importance of future rewards |
| Batch Size | Number of experiences used during training |
| Replay Memory | Stores previous agent experiences |
| Epsilon | Controls exploration vs exploitation |
| Target Update Frequency | Controls target-network updates |
...
| Metric | Result |
|---|---:|
| Detection Accuracy | **0.999084** |
| Average Reward | **12.16 Million** |
| Final Training Loss | **171.18** |
...
| Metric | Result |
|---|---:|
| Detection Accuracy | **0.999763** |
| Average Reward | **12.16 Million** |
| Final Training Loss | **163.3870** |
| Convergence | **Highly Stable** |
...
| Model | Accuracy | Reward Performance | Training Stability |
|---|---:|---|---|
| DQN | 0.999318 | Good | Moderate |
| Double DQN | 0.999084 | Better | Stable |
| Dueling DQN | 0.999763 | Best/Compare after values | Highly Stable |
...
|---|---|---|
| DQN | Simple architecture and effective baseline learning | Sensitive to Q-value overestimation |
| Double DQN | More stable learning and reliable Q-value estimation | Slightly increased computational complexity |
| Dueling DQN | Better understanding of important states and improved decision quality | More complex network architecture |
...
**Project Title:** Deep Reinforcement Learning-Based Anomaly Detection Using DQN, Double DQN, and Dueling DQN on CERT Insider Threat Dataset

**Short Title:** Anomaly Detection with Learning Agents
...
- Taimoor Ahmad — 20054191
- Mohd Daneel Khan — 20084451
- Sayed Muneeb Ahmed Bukhari — 20093306
- Sarmad Bin Arshad — 20089255
- Usama Murtaza Awan — 20060983

---

# References

The project report references foundational work on Deep Q-Networks, Double DQN, Dueling DQN, anomaly detection, deep-learning-based anomaly detection, reinforcement learning, and deep reinforcement learning for cybersecurity.

Key references listed in the report include:

1. Mnih et al. — *Human-level control through deep reinforcement learning.*
2. Van Hasselt, Guez and Silver — *Deep Reinforcement Learning with Double Q-learning.*
3. Wang et al. — *Dueling Network Architectures for Deep Reinforcement Learning.*
4. Chandola, Banerjee and Kumar — *Anomaly Detection: A Survey.*
5. Chalapathy and Chawla — *Deep Learning for Anomaly Detection: A Survey.*
6. Sutton and Barto — *Reinforcement Learning: An Introduction.*
7. Nguyen and Reddi — *Deep Reinforcement Learning for Cyber Security.*
