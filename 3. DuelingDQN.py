...
os.makedirs("Models/DuelingDQN", exist_ok=True)
...
def build_model():
    return DuelingDQNetwork().to(DEVICE)


print("="*80)
print("DUELING DQN NETWORK CREATED")
print("="*80)
...
class DuelingDQNAgent:
    ...
    # ======================================================
    # Experience Replay (VANILLA DQN TARGET)
    # ======================================================
    ...
    def replay(self):
        ...
        # Target Q Values (target network selects AND evaluates)
        with torch.no_grad():
...
print("=" * 80)
print("DUELING DQN TRAINING STARTED")
print("=" * 80)
...
for episode in range(1, EPISODES + 1):
    ...
    if episode_reward > best_reward:
        ...
        torch.save(
            ...
            "Models/DuelingDQN/best_dueling_dqn_model.pth"
        )
...
}).to_csv("Results/DuelingDQN/DuelingDQN_TrainingHistory.csv", index=False)
...
print("\n")
print("="*80)
print("MODEL PERFORMANCE (DUELING DQN)")
print("="*80)
...
metrics.to_csv("Results/DuelingDQN/DuelingDQN_Metrics.csv", index=False)
...
predictions.to_csv("Results/DuelingDQN/DuelingDQN_Predictions.csv", index=False)
